========================================================================
		ActiveX Control DLL : REARAP
========================================================================

ControlWizard has created this project for your REARAP ActiveX Control
...
that make up your REARAP ActiveX Control DLL.
...
RearApCtl.h
	This file contains the declaration of the CRearApCtrl C++ class.

RearApCtl.cpp
	This file contains the implementation of the CRearApCtrl C++ class.

RearApPpg.h
	This file contains the declaration of the CRearApPropPage C++ class.

RearApPpg.cpp
	This file contains the implementation of the CRearApPropPage C++ class.

RearApCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CRearApCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file RearAp.rc.
