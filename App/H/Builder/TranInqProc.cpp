...
int CTranCmn::fnAPPC_TranInqProc()
{
	...
	while (1)
	{
		...
		switch (nNextState)
		{
			...
			// TransactionInquiryCheckDeviceAction
			...
			// TransactionInquiryCheckMenuContinue
