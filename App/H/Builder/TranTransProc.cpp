...
////////////////////////////////////////////////////////////////////////////////
// File Name   : fnAPPC_TranTransProc
// Description : Transfer
// Parameter   : Nothing
...
// Copyright (c) 2004, Nautilus Hyosung Inc
////////////////////////////////////////////////////////////////////////////////
int CTranCmn::fnAPPC_TranTransProc()
{
	// Start Value Setting
	int nNextState = TRANSACTIONTRANSFERINITIALIZE_STA;
	
	while (1)
	{
		MsgDump(TRACE_CODE_MODE, "Log", __FILE__, __LINE__,
			"fnAPPC_TranTransProc:m_nRetCode[%d], nNextState[%d]", m_nRetCode, nNextState);

		// According to nNextState-Value, branch next step
		switch (nNextState)
		{
			// TransactionTransferInitialize
			case TRANSACTIONTRANSFERINITIALIZE_STA:
			...
			case SETPROCEDURECOUNT1_STA:
				...
				{
					case RET_NEXT_STEP:                              // NextStep
						nNextState = TRANSACTIONTRANSFERINPUT_STA;
						break;
					default:                                         // abnormal end
						fnAPP_CancelProc(T_PROGRAM);
				}
			...
			case TRANSACTIONTRANSFERINPUT_STA:
			...
			case SETPROCEDURECOUNT5_STA:
				...
				{
					case RET_NEXT_STEP:                              // NextStep
						nNextState = TRANSACTIONTRANSFEROUTPUT_STA;
						break;
					default:                                         // abnormal end
						fnAPP_CancelProc(T_PROGRAM);
				}
			...
			// TransactionTransferOutput
			case TRANSACTIONTRANSFEROUTPUT_STA:
				fnAPPF_TransactionTransferOutput();
				switch(m_nRetCode)
				{
					case RET_NEXT_STEP:                              // NextStep
						nNextState = TRANSACTIONTRANSFERCHECKDEVICEACTION_STA;
						break;
					default:                                         // abnormal end
						fnAPP_CancelProc(T_PROGRAM);
				}
			...
			// TransactionTransferCheckDeviceAction
			case TRANSACTIONTRANSFERCHECKDEVICEACTION_STA:
				fnAPPF_TransactionTransferCheckDeviceAction();
				switch(m_nRetCode)
				{
					case RET_NEXT_STEP:                              // NextStep
						nNextState = TRANSACTIONTRANSFERCHECKMENUCONTINUE_STA;
						break;
					default:                                         // abnormal end
						fnAPP_CancelProc(T_PROGRAM);
				}
			...
			// TransactionTransferCheckMenuContinue
			case TRANSACTIONTRANSFERCHECKMENUCONTINUE_STA:
