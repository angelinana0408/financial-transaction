...
int CTranCmn::fnAPPC_TranDepProc()
{
	...
	while (1)
	{
		...
		switch (nNextState)
		{
			...
			// TransactionDepositCheckDeviceAction
			...
			// TransactionDepositCheckMenuContinue
