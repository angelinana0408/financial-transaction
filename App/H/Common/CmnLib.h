...
DllUseport	int		WINAPI IniFlush(LPCTSTR szFileName);
...
DllUseport	int		WINAPI AtmGetAdapterId();
...
DllUseport	int		WINAPI DesEncryptDecrypt(UCHAR*  szKey, UCHAR* szData, int Mode);
...
DllUseport	int		WINAPI hy_CheckAuthorithCodeFromFile3();
DllUseport	bool	WINAPI hy_GetIdentifyCode3(char* pBuffer, int iSize);
DllUseport	void	WINAPI hy_SaveAuthorithCode3(const unsigned char* pIdenCode, const unsigned char* pAuthCode);

//////////////////////////////////////////////////////////////////////
//	hy_monitor.cpp
//////////////////////////////////////////////////////////////////////
DllUseport	void	WINAPI hy_HCMonitor2_Register();
DllUseport	int		WINAPI hy_HCMonitor2_GetDeviceCount();
DllUseport	DWORD	WINAPI hy_HCMonitor2_CustomerServiceBegin();
DllUseport	void	WINAPI hy_HCMonitor2_CustomerServiceEnd( DWORD dwCustomer );
DllUseport	void	WINAPI hy_HCMonitor2_AddInfo( DWORD dwCustomer, const char* pCardNo, const char* pTrans, const char* pResult );
DllUseport	void	WINAPI hy_HCMonitor2_StartCap( DWORD dwSlotNum, DWORD dwCustomer, const char* pCardNo, const char* pTrans, const char* pResult );
DllUseport	void	WINAPI hy_HCMonitor2_StartCapWithCapSeconds( DWORD dwSlotNum, DWORD dwSeconds, DWORD dwCustomer, const char* pCardNo, const char* pTrans, const char* pResult );
DllUseport	void	WINAPI hy_HCMonitor2_StopCap( DWORD dwSlotNum );
DllUseport	void	WINAPI hy_HCMonitor2_StopCapAfterSeconds( DWORD dwSlotNum, DWORD dwSeconds );
DllUseport	void	WINAPI hy_HCMonitor2_SetVideoSize( DWORD dwSlotNum, DWORD dwWidth, DWORD dwHeight );
DllUseport	void	WINAPI hy_HCMonitor2_StartPreRecording( DWORD dwSlotNum, DWORD dwSeconds );
DllUseport	void	WINAPI hy_HCMonitor2_RestartAllowed();
//////////////////////////////////////////////////////////////////////
#endif
