...
/////////////////////////////////////////////////////////////////////////////
	...
	if (PrintDevice & DEV_SPR)
	{
		...
		fnAPP_EditPrintLine(DEV_SPR, ShuData[nSlipIndex +  5],  5, HiddenFlag); // by linji 20080304
		fnAPP_EditPrintLine(DEV_SPR, ShuData[nSlipIndex +  7],  7, HiddenFlag);
		...
		fnAPP_EditPrintLine(DEV_SPR, ShuData[nSlipIndex + 15], 15, HiddenFlag);
		fnAPP_EditPrintLine(DEV_SPR, ShuData[nSlipIndex + 17], 17, HiddenFlag);
...
/////////////////////////////////////////////////////////////////////////////
	if (PrintDevice & DEV_SPR)					// 收条纸打印处理   需要修改   by zjd
	{
		switch (LineNum)
		{
			case 5:												// Date Time	by linji 20080304
...
// 						Data = GetSprintf("    ***%4.4s", &(GetSprintf("%s",ACHostRespRemitAssu[ACHostResp.RecNum].PayeeAccount).GetBuffer(0)[sizeof(ACHostRespRemitAssu[ACHostResp.RecNum].PayeeAccount)-4]),4); //收款账号要分开处理BY HYL
			...
			case 17:											// Reference No, Serial No, Atm Serial Number
				if (TranCode == TC_WITHDRAWAL)
				{
